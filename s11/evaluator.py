...
project_root = "/root/dippy-bittensor-subnet"
sys.path.append(project_root)
print("Current PYTHONPATH:", sys.path)  # Отладочная печать
# Установите полный путь к корневой директории проекта
project_root = "/root/dippy-bittensor-subnet"

# Добавляем полный путь к корневой директории проекта
sys.path.append(project_root)
...
DEFAULT_HOME_DIR = os.environ.get("EVALUATOR_HOME_DIR", "/root/dippy-bittensor-subnet")
